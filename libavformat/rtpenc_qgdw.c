...
{
    RTPQDWMuxContext *s = s1->priv_data;
...
const AVOutputFormat ff_rtp_qgdw_muxer = {
    .name              = "rtp_qgdw",
    .long_name         = "rtp_qgdw",
    .priv_data_size    = sizeof(RTPQGDWMuxContext),
